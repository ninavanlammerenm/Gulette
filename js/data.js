...
const CHAPTERS=[
  ...
  { id:'ch1', label:'🌸 Hoofdstuk 1 · Eerste woorden', color:'#FF6B9D', lessons:[
    ...
    { id:'greet1', title:'Begroetingen', sub:'Hoi, dag, hoe gaat het', icon:'👋', xp:10,
      ...
      words:[
        ...
        {hz:'نام من',tr:'naam-e ma',nl:'Mijn naam',tip:'"نام" + "من" — analytische bezitsvorm (ezafe), essentieel om jezelf voor te stellen'},
      ],
      sentences:[
    ...
    { id:'greet2', title:'Meer begroetingen', sub:'Goedemorgen, welkom!', icon:'☀️', xp:15,
      ...
      words:[
        ...
        {hz:'بعداً می‌بینمت',tr:'badan mibinamet',nl:'Tot ziens',tip:''},
  ...
  { id:'ch2', label:'🏡 Hoofdstuk 2 · Thuis & Familie', color:'#FF8C61', lessons:[
    ...
    { id:'food', title:'Eten & Drinken', sub:'Chai, naan, bolani...', icon:'🍵', xp:20,
      ...
      words:[
        ...
        {hz:'تشنه',tr:'toshna',nl:'Dorstig',tip:'"آب می‌خوام، تشنه‌ام" = ik wil water, ik heb dorst'},
  ...
  { id:'ch3', label:'💕 Hoofdstuk 3 · Gevoel & Dagelijks', color:'#A78BFA', lessons:[
    ...
    { id:'weather', title:'Weer & Seizoenen', sub:'Warm, koud, sneeuw...', icon:'🌤️', xp:25,
      ...
      words:[
        ...
        {hz:'خورشید',tr:'khoshid',nl:'Zon',tip:''},
  ...
  { id:'ch4', label:'💬 Hoofdstuk 4 · Conversatie', color:'#3DD6A3', lessons:[
    ...
    { id:'shopping', title:'Winkelen', sub:'Kopen, prijzen, handelen', icon:'🛒', xp:30,
      ...
      words:[
        ...
        {hz:'نمی‌خوام',tr:'na-me-khom',nl:'Ik wil het niet',tip:'Beleefde weigering — zeg dit rustig, niet bruusk'},
    ...
    { id:'flirt', title:'Romantiek & Gevoelens', sub:'Ik mis je, je bent mooi...', icon:'💌', xp:35,
      ...
      words:[
        ...
        {hz:'یار من',tr:'yaar-e ma',nl:'Mijn geliefde',tip:'"یار" = vriend/geliefde in Hazaragi poëzie — analytische vorm: yaar-e ma'},
        {hz:'نمی‌تانم بی‌تو باشم',tr:'na-me-taanom bi-tu baashom',nl:'Ik kan niet zonder jou',tip:'Hazaragi: "تانستن"'},
  ...
  { id:'ch5', label:'🌟 Hoofdstuk 5 · Cultuur & Slang', color:'#FFBE3D', lessons:[
    ...
    { id:'internet', title:'WhatsApp & Berichten', sub:'Online Hazaragi', icon:'📱', xp:30,
      ...
      words:[
        ...
        {hz:'بعداً زنگ می‌زنم',tr:'ba\'dan zang me-zanom',nl:'Ik bel je later',tip:'"زنگ زدن" = bellen — vaste telefonische afscheidszin'},
  ...
  { id:'ch_gram1', label:'📖 Grammatica 1 · Basis', color:'#8B6FF0', lessons:[
    ...
    { id:'gram1_meervoud', title:'Meervoud: -ها / -ان', sub:'Boeken, kinderen, vrienden...', icon:'📚', xp:25,
      ...
      words:[
        {hz:'کتاب‌ها',tr:'ketaab-haa',nl:'Boeken',tip:'"کتاب" + "-ها" — zo simpel!',tag:'MV'},
        {hz:'بچه‌ها',tr:'bacha-haa',nl:'Kinderen',tip:'Meest gebruikte meervoud in Hazaragi',tag:'MV'},
        {hz:'خانه‌ها',tr:'khaana-haa',nl:'Huizen',tip:'"خانه" + "-ها"',tag:'MV'},
        {hz:'دوست‌ها',tr:'dost-haa',nl:'Vrienden (dagelijks)',tip:'Hazaragi spreektaal — "-ها" voor mensen',tag:'MV'},
        {hz:'دوستان',tr:'dostaan',nl:'Vrienden (formeel)',tip:'"-ان" = formeler, meer schrijftaal',tag:'MV'},
        {hz:'مردها',tr:'mard-haa',nl:'Mannen',tip:'',tag:'MV'},
        {hz:'زن‌ها',tr:'zan-haa',nl:'Vrouwen',tip:'',tag:'MV'},
        {hz:'گل‌ها',tr:'gol-haa',nl:'Bloemen',tip:'"بهار آمد، گل‌ها شگفت" = lente is er, bloemen bloeien',tag:'MV'},
      ],
      sentences:[
  ...
  { id:'ch6', label:'💎 Hoofdstuk 6 · Gevorderd', color:'#5BB8FF', lessons:[
    ...
    { id:'stories', title:'Verleden tijd', sub:'Verhalen & verleden', icon:'📖', xp:40,
      ...
      words:[
        ...
        {hz:'رفت',tr:'raft',nl:'Ging',tip:'"رفتم" = ik ging',tag:'VT'},
        {hz:'آمد',tr:'aamad',nl:'Kwam',tip:'Verleden stam van "آمدن" — "آمدم" = ik kwam',tag:'VT'},
        {hz:'گفت',tr:'goft',nl:'Zei',tip:'Verleden stam van "گفتن" — "گفتم" = ik zei',tag:'VT'},
        {hz:'دید',tr:'did',nl:'Zag',tip:'Verleden stam van "دیدن" — "دیدم" = ik zag',tag:'VT'},
        {hz:'بود',tr:'bood',nl:'Was',tip:'Verleden van "بودن/اَس" — "بودم" = ik was',tag:'VT'},
        {hz:'خورد',tr:'khord',nl:'At',tip:'Verleden stam van "خوردن" — "خوردم" = ik at',tag:'VT'},
        {hz:'کرد',tr:'kard',nl:'Deed',tip:'Verleden stam van "کردن" — meest gebruikte werkwoord',tag:'VT'},
        {hz:'گرفت',tr:'gereft',nl:'Nam / Pakte',tip:'Verleden stam van "گرفتن" — "گرفتم" = ik pakte',tag:'VT'},
        {hz:'برگشت',tr:'bargasht',nl:'Keerde terug',tip:'"بر" + "گشت" = terug + draaide — ook: "برگرد!" = kom terug!',tag:'VT'},
      ],
      sentences:[
    ...
    { id:'opinions', title:'Meningen & Debat', sub:'Ik denk, ik ben het eens...', icon:'🗣️', xp:40,
      ...
      words:[
        ...
        {hz:'به نظر من',tr:'ba nazar-e ma',nl:'Naar mijn mening',tip:'Letterlijk: "in oog/blik van mij" — analytische vorm, beleefde opener'},
        {hz:'فکر می‌کنم',tr:'fekr me-konom',nl:'Ik denk dat...',tip:'Inleidingszin voor meningen — volg altijd met "که" + zin'},
  ...
  { id:'ch_gram2', label:'📖 Grammatica 2 · Werkwoorden', color:'#8B6FF0', lessons:[
    ...
    { id:'gram2_heden', title:'Tegenwoordige tijd', sub:'Ik ga, jij eet, hij zegt...', icon:'⏰', xp:30,
      ...
      words:[
        {hz:'می‌رم',tr:'me-rom',nl:'Ik ga',tip:'"می‌" + stam "ر" (van رفتن) + "-م" → Hazaragi: -om'},
        ...
        {hz:'می‌خورم',tr:'me-khorom',nl:'Ik eet',tip:'Stam van "خوردن" = خور'},
        {hz:'می‌گم',tr:'me-gom',nl:'Ik zeg',tip:'Hazaragi stam van "گفتن"'},
        {hz:'می‌دم',tr:'me-dom',nl:'Ik geef',tip:'Stam van "دادن" = د'},
      ],
      sentences:[
    ...
    { id:'gram2_negatie', title:'Negatie', sub:'Niet, geen, helemaal niet...', icon:'🚫', xp:25,
      ...
      words:[
        {hz:'نمی‌رم',tr:'na-me-rom',nl:'Ik ga niet',tip:'"نه" + "می‌رم" → "نمی‌رم"'},
        {hz:'نمی‌خوام',tr:'na-me-khom',nl:'Ik wil niet',tip:''},
        {hz:'نمی‌فامم',tr:'na-me-famom',nl:'Ik weet het niet',tip:'Veelgebruikte zin — leer dit van buiten!'},
  ...
  { id:'ch12', label:'💻 Hoofdstuk 12 · Technologie & Media', color:'#3DD6A3', lessons:[
    ...
    { id:'news_media', title:'Nieuws & Actualiteit', sub:'Nieuws, oorlog, politiek...', icon:'📰', xp:45,
      ...
      words:[
        ...
        {hz:'انتخابات',tr:'entekhaabaat',nl:'Verkiezingen',tip:'Van Arabisch "انتخاب" = keuze + "-ات" meervoud',tag:'MV'},
      ],
      sentences:[
  ...
  { id:'ch15', label:'💼 Hoofdstuk 15 · Beroepen & Ambities', color:'#FF8C61', lessons:[
    ...
    { id:'dreams_ambitions', title:'Dromen & Ambities', sub:'Willen worden, hopen, plannen...', icon:'🌟', xp:50,
      ...
      words:[
        ...
        {hz:'می‌خوام بشم',tr:'me-khom beshom',nl:'Ik wil worden',tip:'Vaste uitdrukking voor ambities'},
  ...
  { id:'ch_gram3', label:'📖 Grammatica 3 · Gevorderd', color:'#8B6FF0', lessons:[
    ...
    { id:'gram3_sov', title:'Zinsbouw: S-O-W', sub:'Subject · Object · Werkwoord', icon:'📐', xp:30,
      ...
      words:[
        {hz:'من نان می‌خورم',tr:'ma naan me-khorom',nl:'Ik eet brood',tip:'S(من) + O(نان) + W(می‌خورم)'},
    ...
    { id:'gram3_verleden', title:'Verleden tijd', sub:'Ik ging, jij at, hij zei...', icon:'⏪', xp:35,
      ...
      words:[
        {hz:'رفتم',tr:'raftom',nl:'Ik ging',tip:'رفت + "-م" → Hazaragi: -om',tag:'VT'},
        {hz:'رفتی',tr:'rafti',nl:'Jij ging',tip:'رفت + "-ی" (jij)',tag:'VT'},
        {hz:'رفت',tr:'raft',nl:'Hij/Zij ging',tip:'Enkel de stam — geen uitgang',tag:'VT'},
        {hz:'رفتیم',tr:'raftim',nl:'Wij gingen',tip:'رفت + "-یم" (wij)',tag:'VT'},
        {hz:'خوردم',tr:'khordom',nl:'Ik at',tip:'Stam "خورد" + "-م" → Hazaragi: -om',tag:'VT'},
        {hz:'گفتم',tr:'goftom',nl:'Ik zei',tip:'Stam "گفت" + "-م" → Hazaragi: -om',tag:'VT'},
        {hz:'دیدم',tr:'didom',nl:'Ik zag',tip:'Stam "دید" + "-م" → Hazaragi: -om',tag:'VT'},
        {hz:'نرفتم',tr:'na-raftom',nl:'Ik ging niet',tip:'"نه" + "رفتم" → "نرفتم"',tag:'VT'},
      ],
      sentences:[
  ...
  { id:'ch17', label:'💊 Hoofdstuk 17 · Gezondheid & Lichaam', color:'#FF6B9D', lessons:[
    ...
    { id:'health_habits', title:'Gezonde Gewoonten', sub:'Slapen, sporten, eten, rusten...', icon:'🧘', xp:18,
      ...
      words:[
        ...
        {hz:'نوشیدن',tr:'noosheedan',nl:'Drinken',tip:'"آب نوشیدن" = water drinken'},
  ...
  { id:'ch_gram4', label:'📖 Grammatica 4 · Modale werkwoorden', color:'#8B6FF0', lessons:[
    ...
    { id:'gram4_modal', title:'Modale werkwoorden', sub:'Kunnen, moeten, mogen...', icon:'⚙️', xp:35,
      ...
      words:[
        ...
        {hz:'می‌تانم',tr:'me-taanom',nl:'Ik kan (Hazaragi)',tip:'Typisch Hazaragi werkwoord'},
        {hz:'نمی‌تانم',tr:'na-me-taanom',nl:'Ik kan niet',tip:''},
        {hz:'می‌تانی',tr:'me-taani',nl:'Jij kan',tip:''},
        {hz:'می‌تانه',tr:'me-taana',nl:'Hij/Zij kan',tip:''},
        {hz:'می‌خوام',tr:'me-khom',nl:'Ik wil',tip:''},
        {hz:'نمی‌خوام',tr:'na-me-khom',nl:'Ik wil niet',tip:''},
      ],
      sentences:[
    ...
    { id:'gram4_future', title:'Toekomende tijd', sub:'Morgen ga ik, ik zal komen...', icon:'🔮', xp:35,
      ...
      words:[
        {hz:'فردا می‌رم',tr:'fardaa me-rom',nl:'Morgen ga ik',tip:'"فردا" maakt het toekomstig'},
        {hz:'می‌خوام برم',tr:'me-khom berom',nl:'Ik ga (straks)',tip:'Letterlijk "ik wil gaan"'},
        {hz:'زود می‌آم',tr:'zod me-oom',nl:'Ik kom snel',tip:''},
        {hz:'بعداً می‌گم',tr:'ba\'dan me-gom',nl:'Ik zeg het later',tip:''},
        {hz:'ایشالله می‌شه',tr:'ishaallah me-sha',nl:'Het zal lukken, inshallah',tip:'Positief toekomstdenken'},
        ...
        {hz:'حتماً می‌آم',tr:'hatman me-oom',nl:'Ik kom zeker',tip:'"حتماً" = absoluut'},
      ],
      sentences:[
  ...
  { id:'ch29', label:'🎭 Hoofdstuk 29 · Rollenspel-scenario\'s', color:'#F9C3Cb', lessons:[
    ...
    { id:'role_visit', title:'Iemand bezoeken', sub:'Binnenkomen, zitten, afscheid', icon:'🏡', xp:35,
      ...
      words:[
        ...
        {hz:'وقت من تنگ اَس',tr:'waqt-e ma tang as',nl:'Mijn tijd is krap / Ik moet gaan',tip:'Beleefd vertrekaankondiging'},
    ...
    { id:'role_phone', title:'Bellen & WhatsApp', sub:'Gesprek starten, sluiten', icon:'📱', xp:30,
      ...
      words:[
        ...
        {hz:'صدات قطع می‌شه',tr:'sadaat qat me-sha',nl:'Je valt weg / Slechte verbinding',tip:''},
        ...
        {hz:'جواب نمی‌دی',tr:'jawaab neme-di',nl:'Je neemt niet op',tip:''},
  ...
  { id:'ch31', label:'👤 Hoofdstuk 31 · Karakter & Persoonlijkheid', color:'#ec4899',
    ...
    { id:'character_describe', title:'Iemand Beschrijven', sub:'Hoe is hij/zij? Karakter, gedrag...', icon:'💬', xp:30,
      ...
      words:[
        ...
        {hz:'به نظر من',tr:'ba nazar-e ma',nl:'Naar mijn mening',tip:''},
        {hz:'حس می‌کنم',tr:'has me-konom',nl:'Ik heb het gevoel dat',tip:''},
  ...
  { id:'ch33', label:'🗺️ Hoofdstuk 33 · Afghanistan & Geografie', color:'#059669',
    ...
    { id:'hazarajat_geo', title:'Hazarajat & Natuur', sub:'Bergen, valleien, meren...', icon:'🏔️', xp:40,
      ...
      words:[
        ...
        {hz:'چشمه',tr:'cheshma',nl:'Bron',tip:'"آب چشمه" = bronwater'},
  ...
  { id:'ch35', label:'🌿 Hoofdstuk 35 · Spreekwoorden & Wijsheid', color:'#16a34a',
    ...
    { id:'proverbs_nature', title:'Spreekwoorden: Natuur', sub:'Wijsheid uit bergen, water, seizoenen...', icon:'🏔️', xp:45,
      ...
      words:[
        {hz:'آب رو سنگ اَس',tr:'aab ro sang as',nl:'Water gaat over steen (volharding)',tip:'Spreekwoord: zachtheid overwint hardheid'},
        {hz:'کوه به کوه نمی‌رسه',tr:'kooh ba kooh name-resa',nl:'Berg naar berg komt niet (mensen wel)',tip:'Spreekwoord: mensen ontmoeten elkaar altijd'},
        {hz:'خار خار را می‌شناسه',tr:'khaar khaar ra me-shenasa',nl:'Doorn kent doorn (gelijken begrijpen elkaar)',tip:'Spreekwoord: gelijkgestemden herkennen elkaar'},
        {hz:'باد می‌آید، ریشه می‌ماند',tr:'baad me-aayad, risha me-maana',nl:'Wind komt en gaat, wortels blijven',tip:'Spreekwoord: wat wortels heeft, blijft staan'},
        {hz:'دریا قطره قطره پر می‌شه',tr:'daryaa qatra qatra por me-sha',nl:'Een rivier vult zich druppel voor druppel',tip:'Spreekwoord: grote dingen beginnen klein'},
        {hz:'برف زمستان را می‌گیره، بهار آزادش می‌کنه',tr:'barf zemestaan ra me-gira, bahaar aazaadash me-kona',nl:'Sneeuw pakt de winter, lente maakt het vrij',tip:'Spreekwoord: moeilijkheid heeft een eind'},
    ...
    { id:'proverbs_life', title:'Spreekwoorden: Levenswijsheid', sub:'Geduld, arbeid, hoop...', icon:'💫', xp:45,
      ...
      words:[
        ...
        {hz:'امید آخرین چیزی اَس که می‌میره',tr:'omid aakherin chizi as ka me-mira',nl:'Hoop is het laatste wat sterft',tip:''},
    ...
    { id:'proverbs_hazara', title:'Hazaragi Uitdrukkingen', sub:'Typisch Hazaragi gezegdes en woorden...', icon:'🐇', xp:40,
      ...
      words:[
        ...
        {hz:'بُوم',tr:'boom',nl:'Was (Hazaragi)',tip:'"خوب بُوم" = ik was goed — "بُوم" ipv "بودم"',tag:'VT'},
        {hz:'می‌رُوم',tr:'me-room',nl:'Ik ga (Hazaragi)',tip:'"الان می‌رُوم" — "رُوم" ipv "روم"'},
  ...
  { id:'ch37', label:'🧘 Hoofdstuk 37 · Mindset & Motivatie', color:'#7c3aed',
    ...
    { id:'mindset_daily', title:'Dagelijkse Motivatiezinnen', sub:'Aanmoediging, felicitaties...', icon:'🌸', xp:35,
      ...
      words:[
        ...
        {hz:'می‌تانی',tr:'me-taani',nl:'Je kunt het',tip:'"می‌تانی!" = je kunt het! — typisch Hazaragi (niet Iraans "می‌تونی")'},
  ...
  { id:'ch41', label:'🗣️ Hoofdstuk 41 · Conversatiestrategieën', color:'#1d4ed8',
    ...
    { id:'conv_clarify', title:'Verduidelijken & Herhalen', sub:'Ik begrijp niet, zeg het opnieuw...', icon:'🔄', xp:35,
      ...
      words:[
        ...
        {hz:'چتور می‌گن؟',tr:'chetor me-gan?',nl:'Hoe zeggen ze dat?',tip:'Vragen hoe je iets zegt'},
        {hz:'به هزارگی چه می‌گن؟',tr:'ba hazaaragi cha me-gan?',nl:'Hoe zeg je dat in Hazaragi?',tip:'Perfecte leervraag!'},
      ],
      sentences:[
    ...
    { id:'conv_agree', title:'Eens of Oneens', sub:'Akkoord, precies, absoluut...', icon:'👍', xp:30,
      ...
      words:[
        ...
        {hz:'نمی‌فامم',tr:'na-me-famom',nl:'Ik weet het niet',tip:'Eerlijk antwoord'},
        {hz:'فکر می‌کنم',tr:'fekr me-konom',nl:'Ik denk dat...',tip:'"فکر می‌کنم خوبَم" = ik denk dat het klopt'},
        {hz:'به نظر من',tr:'ba nazar-e ma',nl:'Naar mijn mening',tip:'Mening geven'},
      ],
      sentences:[
    ...
    { id:'conv_feelings_live', title:'Gevoel Uitdrukken in Gesprek', sub:'Verbaasd, boos, blij reageren...', icon:'😮', xp:35,
      ...
      words:[
        ...
        {hz:'باور نمی‌کنم',tr:'baawor name-konom',nl:'Ik kan het niet geloven',tip:''},
        {hz:'خوشم می‌آد',tr:'khosham me-aad',nl:'Ik vind het leuk / Ik hou ervan',tip:'"خوشم نمی‌آد" = ik hou er niet van'},
  ...
  { id:'ch42', label:'🛒 Hoofdstuk 42 · Winkelen & Onderhandelen', color:'#b45309',
    ...
    { id:'shopping_bargain', title:'Afdingen', sub:'Onderhandelen, laatste prijs, deal...', icon:'🤝', xp:35,
      ...
      words:[
        ...
        {hz:'نمی‌ارزه',tr:'name-arza',nl:'Het is het niet waard',tip:'Klassieke onderhandelingstactiek'},
  ...
  { id:'ch43', label:'🌤️ Hoofdstuk 43 · Weer & Klimaat', color:'#0369a1',
    ...
    { id:'weather_vocab', title:'Weerwoorden', sub:'Zon, regen, sneeuw, wind...', icon:'⛅', xp:35,
      ...
      words:[
        ...
        {hz:'خورشید',tr:'khoshid',nl:'Zon / Zonlicht',tip:''},
    ...
    { id:'climate_afghan', title:'Klimaat & Natuur van Afghanistan', sub:'Droogte, overstromingen, bergen...', icon:'🏔️', xp:40,
      ...
      words:[
        ...
        {hz:'آب و هوا',tr:'aab wa hawaa',nl:'Klimaat',tip:'"آب" = water + "هوا" = lucht'},
  ...
  { id:'ch45', label:'🏛️ Hoofdstuk 45 · Geschiedenis & Samenleving', color:'#4c1d95',
    ...
    { id:'society_rights', title:'Samenleving & Rechten', sub:'Wet, recht, gelijkheid, vrede...', icon:'⚖️', xp:40,
      ...
      words:[
        ...
        {hz:'انتخابات',tr:'entekhaabaat',nl:'Verkiezingen',tip:'',tag:'MV'},
  ...
  { id:'ch46', label:'🍳 Hoofdstuk 46 · Koken & Afghaanse Keuken', color:'#92400e',
    ...
    { id:'cooking_methods', title:'Kooktechnieken', sub:'Bakken, braden, stomen, koken...', icon:'👨‍🍳', xp:35,
      ...
      words:[
        ...
        {hz:'آب‌پز کردن',tr:'aab-paz kardan',nl:'Koken in water',tip:''},
  ...
  { id:'ch48', label:'🩺 Hoofdstuk 48 · Bij de Dokter', color:'#0f766e',
    ...
    { id:'doctor_advice', title:'Gezondheidsadvies', sub:'Bewegen, rusten, eten, slapen...', icon:'🏃', xp:30,
      ...
      words:[
        ...
        {hz:'آب زیاد',tr:'aab-e ziyaad',nl:'Veel water drinken',tip:'Universeel gezondheidsadvies'},
      ],
      sentences:[
  ...
  { id:'ch_gram7', label:'📖 Grammatica 7 · Tijden & Ezafe', color:'#8B6FF0', lessons:[
    ...
    { id:'gram7_imperfect', title:'Onvoltooid verleden tijd', sub:'Ik ging altijd, ik was aan het gaan...', icon:'⏪', xp:40,
      ...
      words:[
        {hz:'می‌رفتم',tr:'me-raftom',nl:'Ik ging (altijd/was aan het gaan)',tip:'"می‌" + verleden stam "رفت" + "-م"',tag:'VT'},
        {hz:'می‌رفتی',tr:'me-rafti',nl:'Jij ging (altijd)',tip:'Zelfde uitgang -i als tegenwoordige tijd!',tag:'VT'},
        {hz:'می‌رفت',tr:'me-raft',nl:'Hij/zij ging (altijd)',tip:'Stam zonder uitgang voor hij/zij',tag:'VT'},
        {hz:'می‌خوردم',tr:'me-khordom',nl:'Ik at (gewoonlijk)',tip:'"خورد" = verleden stam van "خوردن"',tag:'VT'},
        {hz:'می‌گفتم',tr:'me-goftom',nl:'Ik zei (altijd)',tip:'"گفت" = verleden stam van "گفتن"',tag:'VT'},
        {hz:'می‌کردم',tr:'me-kardom',nl:'Ik deed (gewoonlijk)',tip:'"کرد" = verleden stam — Hazaragi: -om!',tag:'VT'},
        {hz:'می‌بودم',tr:'me-boodom',nl:'Ik was (vroeger)',tip:'"بود" = verleden stam van "بودن"',tag:'VT'},
      ],
      sentences:[
    ...
    { id:'gram7_ke', title:'که-bijzinnen', sub:'Ik weet dat..., de man die...', icon:'🔀', xp:40,
      ...
      words:[
        ...
        {hz:'می‌فامم که',tr:'me-famom ka',nl:'Ik weet dat',tip:'Veelgebruikte combinatie — leer als één blok'},
        {hz:'فکر می‌کنم که',tr:'fekr me-konom ka',nl:'Ik denk dat',tip:'"فکر" = gedachte/mening'},
        {hz:'می‌گم که',tr:'me-gom ka',nl:'Ik zeg dat',tip:''},
  ...
  { id:'ch_eten', label:'🍽️ Eten & Drinken · Hazaragi Keuken', color:'#e07040', lessons:[
    ...
    { id:'eten_smaak', title:'Smaken & Maaltijden', sub:'Lekker, zout, zoet, ontbijt...', icon:'😋', xp:25,
      ...
      words:[
        ...
        {hz:'تند',tr:'tond',nl:'Pittig / Scherp',tip:'"تند اَس، آب می‌خوام" = het is pittig, ik wil water'},
