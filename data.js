...
const CHAPTERS=[
  ...
  { id:'ch43', label:'🌤️ Hoofdstuk 43 · Weer & Klimaat', color:'#0369a1',
    ...
    { id:'weather_describe', title:'Weer Beschrijven', sub:'IJzig, nat, droog, temperatuur...', icon:'🌡️', xp:30,
      ...
      words:[
        ...
        {hz:'رطوبت',tr:'ratobat',nl:'Vochtigheid',tip:''},
  ...
  { id:'ch51', label:'🎊 Hoofdstuk 51 · Feesten & Vieringen', color:'#6d28d9',
    ...
    { id:'birthday_celebrate', title:'Verjaardag & Jubileum', sub:'Taart, kaars, wens, cadeau...', icon:'🎂', xp:30,
      ...
      words:[
        ...
        {hz:'خوشی',tr:'khoshi',nl:'Vreugde / Blijdschap',tip:''},
  ...
  { id:'ch52', label:'📖 Hoofdstuk 52 · Grammatica 6 — Vraagzinnen & Tijdsuitdrukkingen', color:'#065f46',
    ...
    { id:'gram6_questions', title:'Vraagwoorden', sub:'Wie, wat, waar, wanneer, hoe...', icon:'❓', xp:45,
      pronTips:['ک','چ'],
      grammar:'In Hazaragi staan vraagwoorden NIET noodzakelijk aan het begin — de zin kan ook eindigen op het vraagwoord. "کجا" = waar. "چی" = wat. "چرا" = waarom. "چطور" = hoe.',
      words:[
        ...
        {hz:'چطور',tr:'chetor',nl:'Hoe',tip:'"چطور کار می‌کنه؟" = hoe werkt het?'},
