...
const CHAPTERS=[
  ...
  { id:'ch0', label:'🆘 Overlevingsgids · Als je vastzit', color:'#F06C78', lessons:[
    ...
    { id:'survival_agree', title:'Ja, Nee & Misschien', sub:'Meer dan alleen بله en نه', icon:'👍', xp:15,
      ...
      words:[
        ...
        {hz:'شاید',tr:'shaayad',nl:'Misschien',tip:'"شاید بیام" = misschien kom ik — heel Hazaragi om het zeker niet te beloven'},
    ...
    { id:'survival_practical', title:'Meest gebruikte commando\'s', sub:'Direct toepasbaar', icon:'⚡', xp:20,
      ...
      words:[
        ...
        {hz:'برو',tr:'bero',nl:'Ga / Ga weg',tip:'"زود برو" = ga snel / "نرو" = ga niet'},
        {hz:'بنشین',tr:'benshin',nl:'Ga zitten',tip:'"اینجه بنشین" = ga hier zitten'},
        {hz:'بلند شو',tr:'boland sho',nl:'Sta op',tip:'Letterlijk: "word hoog" — "بلند" = hoog/op'},
        {hz:'ببین',tr:'bebin',nl:'Kijk / Luister eens',tip:'Trekt aandacht — ook: "ببین چی شد" = kijk wat er is gebeurd'},
        {hz:'بگیر',tr:'begir',nl:'Pak aan / Neem',tip:'"بگیر، مال توه" = neem, het is van jou'},
        {hz:'بده',tr:'bede',nl:'Geef (het)',tip:'"بدش" = geef het aan hem/haar'},
        {hz:'نگو',tr:'nago',nl:'Zeg het niet',tip:'"به کسی نگو" = zeg het tegen niemand'},
  ...
  { id:'ch1', label:'🌸 Hoofdstuk 1 · Eerste woorden', color:'#FF6B9D', lessons:[
    ...
    { id:'greet2', title:'Meer begroetingen', sub:'Goedemorgen, welkom!', icon:'☀️', xp:15,
      ...
      words:[
        ...
        {hz:'نوبت تو اَس',tr:'nowbat-e to as',nl:'Het is jouw beurt',tip:'"نوبت" = beurt — ook: afspraak'},
    ...
    { id:'numbers', title:'Cijfers 1–10', sub:'Tellen in Hazaragi', icon:'🔢', xp:20,
      ...
      words:[
        ...
        {hz:'نه',tr:'no',nl:'Negen',tip:'Hazaragi: "no" — let op: "نه" is ook "nee"! Context bepaalt de betekenis'},
    ...
    { id:'colors', title:'Kleuren', sub:'Rood, blauw, groen...', icon:'🎨', xp:20,
      ...
      words:[
        ...
        {hz:'صورتی',tr:'sorati',nl:'Roze',tip:'Van "صورت" = gezicht/kleur'},
  ...
  { id:'ch2', label:'🏡 Hoofdstuk 2 · Thuis & Familie', color:'#FF8C61', lessons:[
    ...
    { id:'food', title:'Eten & Drinken', sub:'Chai, naan, bolani...', icon:'🍵', xp:20,
      ...
      words:[
        ...
        {hz:'تشنه',tr:'tashna',nl:'Dorstig',tip:'"آو می‌خوام، تشنه‌ام" = ik wil water, ik heb dorst — merk "آو" (Hazaragi voor water)'},
    ...
    { id:'home_vocab', title:'Thuis', sub:'Kamer, deur, raam...', icon:'🏠', xp:20,
      ...
      words:[
        ...
        {hz:'صندلی',tr:'sandali',nl:'Stoel',tip:'Van Arabisch "سندل" — zit meubilair'},
    ...
    { id:'animals', title:'Dieren', sub:'Schapen, ezel, vogels...', icon:'🐑', xp:20,
      ...
      words:[
        ...
        {hz:'مرغ',tr:'morgh',nl:'Kip',tip:'"مرغ" = ook vogel in het algemeen — "مرغ پخته" = gekookte kip'},
        {hz:'سگ',tr:'sag',nl:'Hond',tip:'In Hazara/Afghaanse cultuur wordt hond als onrein beschouwd — "سگ!" als scheldwoord'},
        {hz:'گربه',tr:'gorba',nl:'Kat',tip:'Hazaragi: "gorba" — kat is gerespecteerder dan hond in islamitische cultuur'},
  ...
  { id:'ch3', label:'💕 Hoofdstuk 3 · Gevoel & Dagelijks', color:'#A78BFA', lessons:[
    ...
    { id:'emotions', title:'Gevoelens', sub:'Blij, moe, verliefd...', icon:'💕', xp:25,
      ...
      words:[
        ...
        {hz:'عصبانی',tr:'asabaani',nl:'Boos',tip:'"عصبانی شدم" = ik werd boos — "نشو" = word niet boos'},
    ...
    { id:'daily', title:'Dagelijks leven', sub:'Werk, tijd, geld...', icon:'📅', xp:25,
      ...
      words:[
        ...
        {hz:'فردا',tr:'farda',nl:'Morgen',tip:'"فردا می‌آم" = ik kom morgen — in Hazaragi cultuur flexibel tijdsbegrip!'},
        {hz:'دیروز',tr:'diroz',nl:'Gisteren',tip:'Hazaragi: "diroz" — let op: korte i'},
        {hz:'حالی',tr:'haali',nl:'Nu / Op dit moment',tip:'Hazaragi: "haali"'},
        {hz:'بعد',tr:'baad',nl:'Later / Daarna',tip:'"بعداً می‌آم" = ik kom later — "بعد از" = na (tijdsaanduiding)'},
      ],
      sentences:[
    ...
    { id:'weather', title:'Weer & Seizoenen', sub:'Warm, koud, sneeuw...', icon:'🌤️', xp:25,
      ...
      words:[
        {hz:'هوا',tr:'hawa',nl:'Weer / Lucht',tip:'"هوا خوش اَس" = het weer is mooi — ook: "هوای تو دارم" = ik denk aan jou (figuurlijk)'},
        ...
        {hz:'باران',tr:'baaran',nl:'Regen',tip:'"باران رحمت اَس" = regen is genade — religieuze uitdrukking in Hazaragi'},
    ...
    { id:'body', title:'Het Lichaam', sub:'Hoofd, hand, hart...', icon:'🫀', xp:25,
      ...
      words:[
        ...
        {hz:'دندان',tr:'dandaan',nl:'Tand',tip:'"دندانم درد می‌کنه" = mijn tand doet pijn'},
      ],
      sentences:[
  ...
  { id:'ch4', label:'💬 Hoofdstuk 4 · Conversatie', color:'#3DD6A3', lessons:[
    ...
    { id:'compliments', title:'Complimenten', sub:'Je bent mooi, goed zo!', icon:'🌸', xp:30,
      ...
      words:[
        ...
        {hz:'باهوش',tr:'baahoosh',nl:'Slim',tip:'"باهوش" = letterlijk met-verstand — groot compliment voor Hazara kinderen'},
    ...
    { id:'flirt', title:'Romantiek & Gevoelens', sub:'Ik mis je, je bent mooi...', icon:'💌', xp:35,
      ...
      words:[
        {hz:'دوستت دارم',tr:'dostat darom',nl:'Ik hou van jou',tip:'Zeg je ook tegen ouders, kinderen en goede vrienden — niet alleen romantisch'},
        ...
        {hz:'رویا',tr:'roya',nl:'Droom / Lieveling',tip:'Zowel "droom" als vrouwennaam — "رویایم" = mijn droom'},
      ],
      sentences:[
  ...
  { id:'ch_gram1', label:'📖 Grammatica 1 · Basis', color:'#8B6FF0', lessons:[
    ...
    { id:'gram1_bezit', title:'Bezit: -م / -ت / -ش', sub:'Mijn, jouw, zijn/haar...', icon:'🔑', xp:25,
      ...
      words:[
        ...
        {hz:'کتابش',tr:'ketaabash',nl:'Zijn/haar boek',tip:'"کتابش کجاست؟" = waar is zijn/haar boek?'},
      ],
      sentences:[
    ...
    { id:'gram1_meervoud', title:'Meervoud: -ها / -ان', sub:'Boeken, kinderen, vrienden...', icon:'📚', xp:25,
      pronTips:['ه'],
      grammar:'Hazaragi meervoud: plak "-ها" achter bijna elk woord — voor dingen én mensen. "بچه‌ها" = kinderen. "-ان" bestaat ook maar is formeler. In dagelijks Hazaragi spreektaal gebruik je ALTIJD "-ها".',
      words:[
      ...
      sentences:[
        ...
        {hz:'کتاب‌هایم کجاست؟',tr:'ketaab-haayam kojast?',nl:'Waar zijn mijn boeken?',tip:'"-هایم" = mijn ... (meervoud bezit)'},
  ...
  { id:'ch_gram2', label:'📖 Grammatica 2 · Werkwoorden', color:'#8B6FF0', lessons:[
    ...
    { id:'gram2_imperatief', title:'Gebiedende wijs', sub:'Ga! Eet! Kom! Zeg!', icon:'📢', xp:30,
      pronTips:['ب'],
      grammar:'Hazaragi gebiedende wijs: zet "بـ" (be-) vóór de werkwoordstam. "رفتن" → stam "رو" → "برو!" (ga!). Ontkenning: "نه" vóór het werkwoord → "نرو" (ga niet!). Deze vormen hoor je in ELKE Hazaragi zin — leer ze van buiten!',
      words:[
        ...
        {hz:'بگو',tr:'bego',nl:'Zeg! / Vertel! (jij)',tip:'"چی بگم؟" = wat moet ik zeggen?'},
      ...
      sentences:[
        ...
        {hz:'غذا بخور، سرد می‌شه',tr:'ghazaa bekhoor, sard meshe',nl:'Eet je eten, het wordt koud'},
  ...
  { id:'ch15', label:'💼 Hoofdstuk 15 · Beroepen & Ambities', color:'#FF8C61', lessons:[
    ...
    { id:'professions', title:'Beroepen', sub:'Dokter, leraar, ingenieur...', icon:'👨‍💼', xp:45,
      ...
      sentences:[
        ...
        {hz:'آرزومه معلم بشم',tr:'aarozomam mo\'allem besham',nl:'Mijn droom is om leraar te worden'},
  ...
  { id:'ch16', label:'🌿 Hoofdstuk 16 · Natuur & Seizoenen', color:'#3DD6A3', lessons:[
    { id:'nature_seasons', title:'Seizoenen', sub:'Lente, zomer, herfst, winter...', icon:'🌸', xp:18,
      ...
      sentences:[
        ...
        {hz:'خزان آمد، دیگه هوا سرد می‌شه',tr:'khazaan aamad, diga hawaa sard meshe',nl:'De herfst is gekomen, het wordt nu koud'},
      ]
    },
    { id:'nature_land', title:'Natuur & Landschap', sub:'Bergen, rivieren, bomen, bloemen...', icon:'🏔️', xp:18,
      ...
      words:[
        ...
        {hz:'گل',tr:'gol',nl:'Bloem',tip:'"گل" = ook een vrouwennaam'},
        {hz:'آب',tr:'aab',nl:'Water',tip:'Lange aa — "آب صاف" = helder water'},
        {hz:'زمین',tr:'zameen',nl:'Aarde / Grond',tip:'"زمین کشاورزی" = landbouwgrond'},
    ...
    { id:'nature_animals', title:'Dieren', sub:'Paard, koe, kat, vis, konijn...', icon:'🐾', xp:18,
      ...
      words:[
        ...
        {hz:'مرغ',tr:'morgh',nl:'Kip',tip:'"مرغابی" = eend'},
  ...
  { id:'ch17', label:'💊 Hoofdstuk 17 · Gezondheid & Lichaam', color:'#FF6B9D', lessons:[
    ...
    { id:'health_habits', title:'Gezonde Gewoonten', sub:'Slapen, sporten, eten, rusten...', icon:'🧘', xp:18,
      ...
      words:[
        {hz:'خواب',tr:'khaab',nl:'Slaap',tip:'Lange aa — ook: "خواب دیدم" = ik heb gedroomd'},
        ...
        {hz:'استراحت',tr:'estaraahat',nl:'Ontspanning',tip:'"استراحت کو" = ga rusten'},
  ...
  { id:'ch18', label:'🎭 Hoofdstuk 18 · Cultuur & Tradities', color:'#FFBE3D', lessons:[
    { id:'culture_celebrations', title:'Feesten & Tradities', sub:'Nowruz, bruiloft, feestdagen...', icon:'🎉', xp:20,
      ...
      sentences:[
        ...
        {hz:'عید مبارک باشه، هدیه بیار!',tr:'eed mubaarak baasha, hadya biaar!',nl:'Gelukkige Eid, breng een cadeau!'},
      ]
    },
    { id:'culture_music', title:'Muziek & Kunst', sub:'Dohol, sarnai, gedicht, dans...', icon:'🎵', xp:18,
      ...
      words:[
        ...
        {hz:'سرود',tr:'sorod',nl:'Lied / Hymne',tip:'"سرود خواندن" = zingen'},
      ...
      sentences:[
        ...
        {hz:'عروسی بود، همه رقص کردن',tr:'aroosee bood, hama raqs karden',nl:'Het was een bruiloft, iedereen danste'},
      ]
    },
    { id:'culture_food', title:'Hazaragi Keuken', sub:'Bolani, qorma, ashak, qaboli...', icon:'🍽️', xp:18,
      ...
      words:[
        {hz:'بولانی',tr:'bollaanee',nl:'Gevulde flatbread',tip:'Gevuld met prei of aardappel — typisch Afghaans'},
        ...
        {hz:'چلو',tr:'challow',nl:'Gestoomde rijst',tip:'Witte rijst als basis'},
      ...
      sentences:[
        ...
        {hz:'امروز بولانی پختم، بیا بخور',tr:'emroz bollaanee pakhtom, bia bakhoor',nl:'Vandaag heb ik bolani gemaakt, kom eten'},
      ]
    },
  ]},
  ...
  { id:'ch30', label:'📖 Hoofdstuk 30 · Grammatica 5 — Bijwoorden & Vergelijkingen', color:'#6366f1',
    ...
    { id:'gram5_adverbs', title:'Bijwoorden', sub:'Hoe, wanneer, hoeveel...', icon:'⚡', xp:35,
      pronTips:['خ','آ'],
      grammar:'Bijwoorden staan meestal voor het werkwoord: "خیلی خوب اَس" (heel goed is). "هنوز" = nog steeds, "دیگه" = niet meer / al.',
      words:[
        ...
        {hz:'تند',tr:'tand',nl:'Snel',tip:'"تند رفتن" = snel gaan'},
        {hz:'آهسته',tr:'aahesta',nl:'Langzaam',tip:'"آهسته بگو" = zeg het langzaam'},
        {hz:'همیشه',tr:'hamisha',nl:'Altijd',tip:''},
        ...
        {hz:'فقط',tr:'faqat',nl:'Alleen maar',tip:'"فقط یک بار" = slechts één keer'},
        {hz:'البته',tr:'albatta',nl:'Natuurlijk / Zeker',tip:'Bevestigend antwoord'},
        {hz:'شاید',tr:'shaayad',nl:'Misschien',tip:''},
      ],
      sentences:[
        {hz:'تو خیلی تند حرف می‌زنی، آهسته‌تر بگو',tr:'to kheli tand harf mi-zani, aahesta-tar bego',nl:'Jij praat heel snel, spreek wat langzamer'},
        {hz:'من همیشه صبح زود بیدار می‌شم',tr:'ma hamisha sobh zud bediaar mi-shom',nl:'Ik word altijd vroeg in de ochtend wakker'},
        {hz:'شاید فردا بیام، هنوز مطمئن نیستم',tr:'shaayad farda biyaam, hanoz motma\'en nistam',nl:'Misschien kom ik morgen, ik weet het nog niet zeker'},
      ]
    },

    { id:'gram5_compare', title:'Vergelijkingen', sub:'Groter, beter, het beste...', icon:'📊', xp:40,
      pronTips:['خ','آ'],
      grammar:'Vergrotende trap: voeg "-تر" toe: "بزرگ" → "بزرگ‌تر". Overtreffende trap: "-ترین": "بهترین" = het beste. "اَز" = dan (bij vergelijking).',
      words:[
      ...
      sentences:[
        ...
        {hz:'تو بهتر اَز دیروز حرف می‌زنی',tr:'to behtar az diroz harf mi-zani',nl:'Jij praat beter dan gisteren'},
      ]
    },
    ...
    { id:'gram5_conjunctions', title:'Voegwoorden', sub:'Maar, omdat, als, wanneer...', icon:'🔗', xp:35,
      ...
      words:[
        ...
        {hz:'وقتی',tr:'waqti',nl:'Wanneer',tip:'"وقتی کوچک بودم" = toen ik klein was'},
      ...
      sentences:[
        {hz:'می‌خوام بیام اما وقت ندارم',tr:'mi-khwaam biyaam amma waqt nadaaram',nl:'Ik wil komen maar ik heb geen tijd'},
        {hz:'اگه خسته هستی، استراحت کن',tr:'aga khasta hasti, estraahat kon',nl:'Als je moe bent, rust dan uit'},
        {hz:'وقتی بچه بودم، هزارستان زندگی می‌کردم',tr:'waqti bacha budam, hazaarastaan zendagi mi-kardam',nl:'Toen ik klein was, woonde ik in Hazarajat'},
      ]
    },
  ...
  { id:'ch31', label:'👤 Hoofdstuk 31 · Karakter & Persoonlijkheid', color:'#ec4899',
    ...
    { id:'character_pos', title:'Positieve Eigenschappen', sub:'Geduldig, eerlijk, vriendelijk...', icon:'😊', xp:35,
      ...
      sentences:[
        ...
        {hz:'مادرم خیلی مهربان و دلسوز اَس',tr:'maadarom kheli mehrabaan wa delsoz as',nl:'Mijn moeder is heel lief en meelevend'},
    ...
    { id:'character_neg', title:'Negatieve Eigenschappen', sub:'Lui, jaloers, ontrouw...', icon:'😤', xp:35,
      ...
      words:[
        ...
        {hz:'عصبانی',tr:'asabaani',nl:'Opvliegend / Boos',tip:'"عصبانی شدن" = boos worden'},
      ...
      sentences:[
        {hz:'حسود هیچ‌وقت راحت نیست',tr:'hasood hich-waqt raahat nist',nl:'Een jaloers persoon heeft nooit rust'},
  ...
  { id:'ch32', label:'📚 Hoofdstuk 32 · Vakken & Studie', color:'#0ea5e9',
    ...
    { id:'school_subjects', title:'Schoolvakken', sub:'Wiskunde, geschiedenis, talen...', icon:'🏫', xp:35,
      ...
      words:[
        ...
        {hz:'تاریخ',tr:'taariikh',nl:'Geschiedenis',tip:'Ook: datum'},
      ...
      sentences:[
        ...
        {hz:'تاریخ هزاره را باید بدانیم',tr:'taariikh hazaara ra baayad bedaanim',nl:'We moeten de geschiedenis van de Hazara kennen'},
    ...
    { id:'learning_knowledge', title:'Leren & Kennis', sub:'Weten, oefenen, begrijpen...', icon:'💡', xp:35,
      ...
      words:[
        ...
        {hz:'فهمیدن',tr:'fahmidan',nl:'Begrijpen',tip:'"نفهمیدم" = ik begreep het niet'},
      ...
      sentences:[
        ...
        {hz:'اگه نفهمیدی، سوال کو',tr:'aga nafafmidi, soaal ko',nl:'Als je het niet begrijpt, stel dan een vraag'},
  ...
  { id:'ch33', label:'🗺️ Hoofdstuk 33 · Afghanistan & Geografie', color:'#059669',
    ...
    { id:'afghan_cities', title:'Steden van Afghanistan', sub:'Kabul, Bamyan, Mazar...', icon:'🏙️', xp:40,
      ...
      sentences:[
        {hz:'کابل پایتخت افغانستان اَس',tr:'kabol paayetakht afghaanostaan as',nl:'Kabul is de hoofdstad van Afghanistan'},
        ...
        {hz:'آرزو دارم یک بار به مزار شریف بروم',tr:'aarezoo daaram yak baar ba mazaar sharif baravam',nl:'Ik wil ooit een keer naar Mazar-i-Sharif gaan'},
      ]
    },
  ...
  { id:'ch34', label:'🕯️ Hoofdstuk 34 · Speciale Gelegenheden', color:'#d97706',
    ...
    { id:'birth_baby', title:'Geboorte & Baby', sub:'Pasgeboren, naam geven, vieren...', icon:'👶', xp:35,
      ...
      words:[
        ...
        {hz:'ماشاالله',tr:'mashaa-allaah',nl:'Wat mooi/geweldig (bescherming boze oog)',tip:'Zeg dit altijd bij een baby!'},
        {hz:'اسم گذاشتن',tr:'esm gozaashtan',nl:'Een naam geven',tip:'"اسم گذاشتن روی بچه" = naam geven aan kind'},
        {hz:'شیرینی',tr:'shirini',nl:'Snoep / Zoetigheidstractatie',tip:'Bij goed nieuws wordt شیرینی uitgedeeld'},
        {hz:'تولد',tr:'tawalod',nl:'Geboorte / Verjaardag',tip:'"تولدت مبارک" = gefeliciteerd met je verjaardag'},
      ...
      sentences:[
        ...
        {hz:'ماشاالله، خیلی قشنگ اَس!',tr:'mashaa-allaah, kheli qashang as!',nl:'Mashallah, wat is het mooi!'},
        {hz:'چه اسمی رویش گذاشتین؟',tr:'cha esmi rowesh gozaashtid?',nl:'Welke naam hebben jullie hem/haar gegeven?'},
      ]
    },
    ...
    { id:'wedding_details', title:'Bruiloft & Huwelijk', sub:'Verloving, bruidegom, bruid...', icon:'💍', xp:40,
      ...
      words:[
        ...
        {hz:'عروسی',tr:'oroosi',nl:'Bruiloft',tip:'De viering zelf'},
      ...
      sentences:[
        {hz:'عروسی‌شان ماه آینده اَس',tr:'oroosishaan maah-e aaayanda as',nl:'Hun bruiloft is volgende maand'},
        {hz:'عروس خیلی قشنگ بود، ماشاالله',tr:'aros kheli qashang bood, mashaa-allaah',nl:'De bruid was heel mooi, mashallah'},
        {hz:'دعوت عروسی گرفتم، خوشحال شدم',tr:'da\'wat-e oroosi gereftam, khoshaal shodam',nl:'Ik heb een bruiloftsuitnodiging gekregen, ik werd blij'},
      ]
    },
    ...
    { id:'condolences', title:'Condoleances & Rouw', sub:'Overlijden, troost, gebed...', icon:'🕊️', xp:35,
      ...
      sentences:[
        ...
        {hz:'پدرم فوت کرد، خدا رحمتش کنه',tr:'padarom fowt kard, khoda rahmatash kona',nl:'Mijn vader is gestorven, moge God hem genadig zijn'},
  ...
  { id:'ch35', label:'🌿 Hoofdstuk 35 · Spreekwoorden & Wijsheid', color:'#16a34a',
    ...
    { id:'proverbs_nature', title:'Spreekwoorden: Natuur', sub:'Wijsheid uit bergen, water, seizoenen...', icon:'🏔️', xp:45,
      ...
      words:[
        ...
        {hz:'دریا قطره قطره پر می‌شه',tr:'darya qatra qatra por mi-sha',nl:'Een rivier vult zich druppel voor druppel',tip:'Spreekwoord: grote dingen beginnen klein'},
      ...
      sentences:[
        ...
        {hz:'دریا قطره قطره پر می‌شه — صبر داشته باش',tr:'darya qatra qatra por mi-sha — sabr daashte baash',nl:'Een rivier vult zich druppel voor druppel — wees geduldig'},
    ...
    { id:'proverbs_hazara', title:'Hazaragi Uitdrukkingen', sub:'Typisch Hazaragi gezegdes en woorden...', icon:'🐇', xp:40,
      ...
      sentences:[
        ...
        {hz:'بیا یک گپ بزنیم، وقت داری؟',tr:'biyaa yak gap bezanim, waqt daari?',nl:'Kom, laten we even praten, heb je tijd?'},
      ]
    },
  ...
  { id:'ch36', label:'🏪 Hoofdstuk 36 · Dagelijkse Diensten', color:'#7c3aed',
    ...
    { id:'pharmacy', title:'Apotheek & Medicijnen', sub:'Drogist, recept, pillen...', icon:'💊', xp:35,
      ...
      words:[
        {hz:'فارمسی',tr:'faarmasii',nl:'Apotheek',tip:'Afghaans woord (van pharmacy)'},
      ...
      sentences:[
        {hz:'نسخه داکتر را دارم، دوا می‌خوام',tr:'noskha-ye daaktar ra daaram, dawaa mi-khwaam',nl:'Ik heb een recept van de dokter, ik wil medicijnen'},
        {hz:'این قرص برای تب اَس؟',tr:'in qors baraaye tab as?',nl:'Is deze pil voor koorts?'},
        {hz:'آلرژی به پنی‌سیلین دارم',tr:'aalarji ba penisilin daaram',nl:'Ik ben allergisch voor penicilline'},
      ]
    },
    ...
    { id:'barbershop', title:'Kapper', sub:'Haarsnijden, scheren, kapsel...', icon:'✂️', xp:30,
      ...
      words:[
        {hz:'سلمانی',tr:'salmaanik',nl:'Kapper / Barbierszaak',tip:''},
    ...
    { id:'bank_post', title:'Bank & Post', sub:'Overschrijving, storten, brief sturen...', icon:'🏦', xp:35,
      ...
      sentences:[
        {hz:'می‌خوام پول به کابل حواله کنم',tr:'mi-khwaam pool ba kabol hawaala konom',nl:'Ik wil geld overmaken naar Kabul'},
        {hz:'حساب بانکی باز کردن می‌خوام',tr:'hesaab-e baanki baaz kardan mi-khwaam',nl:'Ik wil een bankrekening openen'},
  ...
  { id:'ch37', label:'🧘 Hoofdstuk 37 · Mindset & Motivatie', color:'#7c3aed',
    ...
    { id:'mindset_growth', title:'Groeimindset', sub:'Doelen, inzet, volhouden...', icon:'💪', xp:40,
      ...
      words:[
        ...
        {hz:'اشتباه',tr:'eshtbaah',nl:'Fout / Vergissing',tip:'"اشتباه کردن" = een fout maken — normaal!'},
      ...
      sentences:[
        ...
        {hz:'هر اشتباه یک درس اَس',tr:'har eshtbaah yak dars as',nl:'Elke fout is een les'},
        {hz:'با اراده قوی هر هدفی رسیدنی اَس',tr:'baa eraada-ye qaawi har hadafi rasidani as',nl:'Met sterke wilskracht is elk doel bereikbaar'},
      ]
    },
    ...
    { id:'mindset_feelings', title:'Positieve Gevoelens & Kracht', sub:'Blij, sterk, dankbaar...', icon:'🌟', xp:35,
      ...
      words:[
        ...
        {hz:'انرژی',tr:'energia',nl:'Energie',tip:'"انرژی دارم" = ik heb energie'},
    ...
    { id:'mindset_daily', title:'Dagelijkse Motivatiezinnen', sub:'Aanmoediging, felicitaties...', icon:'🌸', xp:35,
      pronTips:['ب','م'],
      grammar:'"بتونی" = je kunt het (aanmoediging). "مبارک باشه" = van harte gefeliciteerd. "دست مریزاد" = goed gedaan! (letterlijk: moge je hand niet moe worden) — typisch Hazaragi compliment voor goed werk.',
      words:[
  ...
  { id:'ch38', label:'🌺 Hoofdstuk 38 · Liefde & Relaties', color:'#e11d48',
    ...
    { id:'love_feelings', title:'Liefde & Genegenheid', sub:'Liefhebben, missen, koesteren...', icon:'❤️', xp:40,
      ...
      words:[
        {hz:'دوستت دارم',tr:'dostat daaram',nl:'Ik hou van jou',tip:'De meest directe manier — gebruikt voor iedereen die je lief hebt'},
        ...
        {hz:'همیشه',tr:'hamisha',nl:'Altijd',tip:'"همیشه کنارت هستم" = ik ben er altijd voor jou'},
        {hz:'یاد',tr:'yaad',nl:'Herinnering / Denken aan',tip:'"یادت هستم" = ik denk aan jou'},
        {hz:'آرزو',tr:'aarezoo',nl:'Wens / Verlangen',tip:'"آرزویم داری" = jij bent mijn wens'},
      ],
      sentences:[
        {hz:'دوستت دارم، همیشه یادت هستم',tr:'dostat daaram, hamisha yaadot hastom',nl:'Ik hou van jou, ik denk altijd aan jou'},
        {hz:'دلتنگتم وقتی نیستی',tr:'deltangatom waqti nisti',nl:'Ik mis je wanneer je er niet bent'},
    ...
    { id:'love_friendship', title:'Vriendschap', sub:'Vrienden, vertrouwen, loyaliteit...', icon:'🤝', xp:35,
      ...
      sentences:[
        {hz:'رفیق واقعی کنارت اَس در سختی',tr:'rafiq-e waaqe\'i kenaarot as dar sakhti',nl:'Een echte vriend staat naast jou in moeilijke tijden'},
        {hz:'درد دلت را باهام بگو',tr:'dard-e delat ra baahaam bego',nl:'Vertel mij wat je op je hart hebt'},
  ...
  { id:'ch39', label:'🎮 Hoofdstuk 39 · Vrije Tijd & Hobby\'s', color:'#0891b2',
    ...
    { id:'hobbies_sports', title:'Sport & Beweging', sub:'Voetbal, zwemmen, wandelen...', icon:'⚽', xp:35,
      ...
      sentences:[
        ...
        {hz:'فوتبال بازی کردن دوست دارم',tr:'footbaal baazi kardan dost daaram',nl:'Ik hou van voetbal spelen'},
        {hz:'تیم ما برنده شد، خوشحال شدیم',tr:'tim-e maa baranda shod, khoshaal shodim',nl:'Ons team won, we werden blij'},
      ]
    },
    ...
    { id:'hobbies_creative', title:'Creatieve Hobby\'s', sub:'Tekenen, lezen, koken...', icon:'🎨', xp:35,
      ...
      words:[
        ...
        {hz:'موسیقی',tr:'mooseeqi',nl:'Muziek',tip:'"موسیقی گوش دادن" = muziek luisteren'},
      ...
      sentences:[
        ...
        {hz:'در وقت آزادم کتاب می‌خونم',tr:'dar waqt-e aazaadam ketaab mi-khwoom',nl:'In mijn vrije tijd lees ik'},
    ...
    { id:'hobbies_social', title:'Sociale Activiteiten', sub:'Bezoeken, spelletjes, theekrans...', icon:'☕', xp:30,
      ...
      words:[
        {hz:'مهمانی',tr:'mehmaanik',nl:'Feestje / Bijeenkomst',tip:'"مهمانی رفتن" = op visite gaan'},
        ...
        {hz:'چای نوشیدن',tr:'chaai nooshidan',nl:'Thee drinken',tip:'Sociale activiteit bij uitstek'},
      ...
      sentences:[
        {hz:'جمعه مهمانی داریم، میای؟',tr:'jome mehmaanik daarem, miyaai?',nl:'Vrijdag hebben we een bijeenkomst, kom je?'},
        {hz:'مهمان نعمت اَس — این رسم ماست',tr:'mehmaan ne\'mat as — in rasom maast',nl:'Een gast is een zegen — dat is onze traditie'},
        {hz:'با هم چای بخوریم و گپ بزنیم',tr:'baa ham chaai bekhorim wa gap bezanim',nl:'Laten we samen thee drinken en kletsen'},
      ]
    },
  ...
  { id:'ch42', label:'🛒 Hoofdstuk 42 · Winkelen & Onderhandelen', color:'#b45309',
    ...
    { id:'shopping_bazaar', title:'Op de Bazaar', sub:'Kopen, verkopen, prijzen...', icon:'🏪', xp:40,
      ...
      words:[
        ...
        {hz:'فروشنده',tr:'forooshanda',nl:'Verkoper',tip:'"فروختن" = verkopen'},
        {hz:'خریدار',tr:'kharidaar',nl:'Koper / Klant',tip:'"خریدن" = kopen'},
        {hz:'قیمت',tr:'qiymat',nl:'Prijs',tip:'"قیمت چنده؟" = hoeveel kost het?'},
        ...
        {hz:'گران',tr:'garaan',nl:'Duur',tip:'"زیاد گران اَس" = het is te duur'},
      ...
      sentences:[
        {hz:'این چقدر اَس؟',tr:'in cheqadr as?',nl:'Hoeveel kost dit?'},
        {hz:'کمی تخفیف بده، خیلی گران اَس',tr:'kami takhfif beda, kheli garaan as',nl:'Geef wat korting, het is te duur'},
    ...
    { id:'shopping_bargain', title:'Afdingen', sub:'Onderhandelen, laatste prijs, deal...', icon:'🤝', xp:35,
      ...
      words:[
        {hz:'آخرین قیمت',tr:'aakherin qiymat',nl:'Laatste prijs / Bodemprijs',tip:'"آخرین قیمت چنده؟" = wat is je laagste prijs?'},
      ...
      sentences:[
        {hz:'آخرین قیمت چنده؟ راست بگو',tr:'aakherin qiymat chanda? raast bego',nl:'Wat is je laatste prijs? Zeg het eerlijk'},
        {hz:'نمی‌ارزه، جای دیگه می‌رم',tr:'nami-arza, jaaye diga mi-rom',nl:'Het is het niet waard, ik ga ergens anders heen'},
        {hz:'قبول کردم، معامله شد!',tr:'qabol kardam, mo\'aamala shod!',nl:'Ik ga akkoord, we hebben een deal!'},
      ]
    },
    ...
    { id:'shopping_clothes', title:'Kleding Kopen', sub:'Maat, passen, kleur, stof...', icon:'👗', xp:35,
      ...
      words:[
        ...
        {hz:'پرو کردن',tr:'paro kardan',nl:'Passen',tip:'"می‌تونم پرو کنم؟" = mag ik het passen?'},
      ...
      sentences:[
        {hz:'می‌تونم این را پرو کنم؟',tr:'mi-tonom in ra paro konom?',nl:'Mag ik dit passen?'},
        ...
        {hz:'رنگ دیگه‌ای داری؟ سرخ می‌خوام',tr:'rang-e digayi daari? sorkh mi-khwaam',nl:'Heb je een andere kleur? Ik wil rood'},
      ]
    },
  ...
  { id:'ch43', label:'🌤️ Hoofdstuk 43 · Weer & Klimaat', color:'#0369a1',
    ...
    { id:'weather_vocab', title:'Weerwoorden', sub:'Zon, regen, sneeuw, wind...', icon:'⛅', xp:35,
      ...
      words:[
        {hz:'هوا',tr:'hawaa',nl:'Weer / Lucht',tip:'"هوا چطور اَس؟" = hoe is het weer?'},
    ...
    { id:'weather_describe', title:'Weer Beschrijven', sub:'IJzig, nat, droog, temperatuur...', icon:'🌡️', xp:30,
      ...
      words:[
        ...
        {hz:'سایه',tr:'saaya',nl:'Schaduw',tip:'"در سایه بنشین" = ga in de schaduw zitten'},
      ...
      sentences:[
        ...
        {hz:'جاده یخ زده، آهسته بران',tr:'jaada yakh zada, aahesta beraan',nl:'De weg is bevroren, rij langzaam'},
    ...
    { id:'climate_afghan', title:'Klimaat & Natuur van Afghanistan', sub:'Droogte, overstromingen, bergen...', icon:'🏔️', xp:40,
      ...
      words:[
        ...
        {hz:'زلزله',tr:'zelzela',nl:'Aardbeving',tip:'Afghanistan ligt seismisch actief gebied'},
        {hz:'بهمن',tr:'bahman',nl:'Lawine',tip:'Gevaar in Hazarajat in de winter'},
        {hz:'آب و هوا',tr:'aab wa hawaa',nl:'Klimaat',tip:'Letterlijk: water en lucht'},
      ...
      sentences:[
        ...
        {hz:'در زمستان از بهمن بترس، مراقب باش',tr:'dar zemestaan az bahman betars, muraaqeb baash',nl:'Wees in de winter bang voor lawines, wees voorzichtig'},
  ...
  { id:'ch44', label:'👶 Hoofdstuk 44 · Kinderen & Opvoeding', color:'#db2777',
    ...
    { id:'kids_vocab', title:'Kindertaal & Spelletjes', sub:'Spelen, rennen, lachen, huilen...', icon:'🎈', xp:35,
      ...
      words:[
        ...
        {hz:'دویدن',tr:'dawidan',nl:'Rennen',tip:'"آهسته بدو" = ren langzaam'},
      ...
      sentences:[
        ...
        {hz:'گریه نکو، همه چیز درست می‌شه',tr:'gerya nako, hama chiz dorost mi-sha',nl:'Huil niet, alles komt goed'},
    ...
    { id:'parenting_phrases', title:'Opvoedingszinnen', sub:'Wat ouders zeggen...', icon:'👨‍👩‍👧', xp:35,
      ...
      sentences:[
        {hz:'مامان جان، بیا اینجا',tr:'maamaan jaan, biyaa injaa',nl:'Lieve mama, kom hier'},
    ...
    { id:'school_daily', title:'Schoolleven', sub:'Klas, leraar, bel, pauze...', icon:'📝', xp:35,
      ...
      sentences:[
        ...
        {hz:'سوال دارم، معلم صاحب',tr:'soaal daaram, mo\'allem-saaheb',nl:'Ik heb een vraag, meester/juffrouw'},
  ...
  { id:'ch45', label:'🏛️ Hoofdstuk 45 · Geschiedenis & Samenleving', color:'#4c1d95',
    ...
    { id:'history_hazara', title:'Hazara Geschiedenis', sub:'Strijd, identiteit, trots...', icon:'🏔️', xp:50,
      ...
      words:[
        ...
        {hz:'مقاومت',tr:'moqaaomat',nl:'Verzet / Weerstand',tip:'Centrale waarde in Hazara identiteit'},
        {hz:'مهاجرت',tr:'mohaajaratat',nl:'Migratie',tip:'"مهاجر" = migrant/vluchteling'},
        {hz:'پناهنده',tr:'panahanda',nl:'Vluchteling',tip:''},
      ...
      sentences:[
        {hz:'تاریخ هزاره پر از مقاومت اَس',tr:'taariikh-e hazaara por az moqaaomat as',nl:'De geschiedenis van de Hazara is vol van verzet'},
        {hz:'مو هزاره هستیم و با افتخار اَس',tr:'mo hazaara hastim wa baa eftekhar as',nl:'Wij zijn Hazara en dat is met trots'},
        {hz:'نسل جوان باید تاریخ خود را بدانه',tr:'nasl-e jawaan baayad taariikh-e khod ra bedaana',nl:'De jonge generatie moet haar eigen geschiedenis kennen'},
      ]
    },
    ...
    { id:'society_rights', title:'Samenleving & Rechten', sub:'Wet, recht, gelijkheid, vrede...', icon:'⚖️', xp:40,
      ...
      words:[
        {hz:'حق',tr:'haqq',nl:'Recht / Waarheid',tip:'"حق داری" = je hebt gelijk / recht'},
      ...
      sentences:[
        {hz:'هر کس حق آموزش داره',tr:'har kas haqq-e aamozesh daara',nl:'Iedereen heeft recht op onderwijs'},
        {hz:'عدالت و مساوات حق همه اَس',tr:'adaalat wa masaawaat haqq-e hama as',nl:'Gerechtigheid en gelijkheid is ieders recht'},
        {hz:'صلح بهترین هدیه برای مردم اَس',tr:'solh behtarin hadiya baraaye mardom as',nl:'Vrede is het beste geschenk voor het volk'},
      ]
    },
    ...
    { id:'conflict_hope', title:'Oorlog & Hoop op Vrede', sub:'Vluchten, terugkeer, verzoening...', icon:'🕊️', xp:45,
      ...
      sentences:[
        ...
        {hz:'دلم می‌خواد به وطنم برگردم',tr:'delam mi-khaad ba watanoom bargardoom',nl:'Ik wil terugkeren naar mijn vaderland'},
  ...
  { id:'ch46', label:'🍳 Hoofdstuk 46 · Koken & Afghaanse Keuken', color:'#92400e',
    ...
    { id:'spices_ingredients', title:'Kruiden & Ingrediënten', sub:'Specerijen, groenten, vlees...', icon:'🌶️', xp:35,
      ...
      words:[
        ...
        {hz:'گشنیز',tr:'gashneez',nl:'Koriander',tip:'Vers als garnering gebruikt'},
        ...
        {hz:'گوجه',tr:'goja',nl:'Tomaat',tip:''},
        {hz:'روغن',tr:'roghan',nl:'Olie / Vet',tip:''},
        {hz:'گوشت',tr:'gosht',nl:'Vlees',tip:'"گوشت گوسفند" = schapenvlees'},
        {hz:'برنج',tr:'barenj',nl:'Rijst',tip:'Basis van qabuli en plov'},
    ...
    { id:'afghan_dishes', title:'Afghaanse Gerechten', sub:'Qabuli, manto, boulani, naan...', icon:'🍲', xp:40,
      ...
      words:[
        ...
        {hz:'مانتو',tr:'maanto',nl:'Manto (Afghaanse dumplings)',tip:'Gevuld deeg met gehakt en yoghurtsaus'},
        {hz:'بولانی',tr:'boolaani',nl:'Boulani (gevuld platbrood)',tip:'Met aardappel of prei — gefrituurd'},
        ...
        {hz:'شیرچای',tr:'shir-chaai',nl:'Melkthee',tip:'Groene thee met gecondenseerde melk'},
  ...
  { id:'ch47', label:'🚗 Hoofdstuk 47 · Vervoer & Rijden', color:'#1e3a5f',
    ...
    { id:'transport_road', title:'Op de Weg', sub:'Rijden, verkeer, parkeren...', icon:'🛣️', xp:35,
      ...
      sentences:[
        ...
        {hz:'جاده بد اَس، آهسته بران',tr:'jaada bad as, aahesta beraan',nl:'De weg is slecht, rij langzaam'},
      ]
    },
    ...
    { id:'transport_public', title:'Openbaar Vervoer', sub:'Bus, taxi, minibus, halte...', icon:'🚌', xp:30,
      ...
      words:[
        ...
        {hz:'ایستگاه',tr:'istaagaah',nl:'Station / Halte',tip:'"ایستگاه بس" = bushalte'},
        {hz:'بلیت',tr:'balit',nl:'Kaartje / Ticket',tip:'"بلیت بخر" = koop een kaartje'},
    ...
    { id:'transport_problems', title:'Autopech & Problemen', sub:'Lekke band, benzine, monteur...', icon:'🔧', xp:30,
      ...
      sentences:[
        {hz:'پنچر شدم، کمک کن',tr:'panchar shodam, komak kon',nl:'Ik heb een lekke band, help me'},
        {hz:'بنزین تمام شد، نزدیک‌ترین پمپ کجاست؟',tr:'benzin tamaam shod, nazdiktarin pomp kojaast?',nl:'De benzine is op, waar is het dichtstbijzijnde tankstation?'},
        {hz:'موتر خراب شده، مکانیک می‌خواهم',tr:'motar kharaab shoda, mekanik mi-khaaham',nl:'De auto is kapot, ik heb een monteur nodig'},
      ]
    },
  ...
  { id:'ch48', label:'🩺 Hoofdstuk 48 · Bij de Dokter', color:'#0f766e',
    ...
    { id:'doctor_symptoms', title:'Klachten Beschrijven', sub:'Pijn, koorts, duizelig...', icon:'🤒', xp:40,
      pronTips:['د','س'],
      grammar:'"درد" = pijn. "تب" = koorts. "سرماخوردگی" = verkoudheid. In Hazaragi: "خوب نیستم" = ik voel me niet goed. "جای درد کجاست؟" = waar doet het pijn?',
      words:[
        {hz:'درد',tr:'dard',nl:'Pijn',tip:'"درد دارم" = ik heb pijn'},
        {hz:'تب',tr:'tab',nl:'Koorts',tip:'"تب دارم" = ik heb koorts'},
        {hz:'سرماخوردگی',tr:'sarma-khordagi',nl:'Verkoudheid',tip:'"سرما خوردم" = ik ben verkouden'},
    ...
    { id:'doctor_medicines', title:'Medicijnen & Behandeling', sub:'Pillen, drankje, spuit, recept...', icon:'💊', xp:35,
      ...
      words:[
        ...
        {hz:'فارمسی',tr:'faarmasi',nl:'Apotheek',tip:'"فارمسی کجاست؟" = waar is de apotheek?'},
        {hz:'ویتامین',tr:'witaamin',nl:'Vitamine',tip:''},
      ...
      sentences:[
        ...
        {hz:'به آنتی‌بیوتیک حساسیت دارم',tr:'ba anti-biyotik hassaasiyat daaram',nl:'Ik ben allergisch voor antibiotica'},
      ]
    },
    ...
    { id:'doctor_advice', title:'Gezondheidsadvies', sub:'Bewegen, rusten, eten, slapen...', icon:'🏃', xp:30,
      ...
      words:[
        ...
        {hz:'فشار خون',tr:'fashaare khoon',nl:'Bloeddruk',tip:'"فشار خون بالاست" = de bloeddruk is hoog'},
  ...
  { id:'ch49', label:'📱 Hoofdstuk 49 · Telefoon & Technologie', color:'#1d4ed8',
    ...
    { id:'phone_calling', title:'Bellen & Berichten', sub:'Opnemen, sms, WhatsApp...', icon:'📞', xp:35,
      ...
      words:[
        ...
        {hz:'شماره',tr:'shomaar',nl:'Telefoonnummer',tip:'"شماره‌ات چیه؟" = wat is je nummer?'},
      ...
      sentences:[
        ...
        {hz:'شماره‌ات را بده، واتساپ می‌فرستم',tr:'shomaarat ra beda, waatsaap mi-ferestam',nl:'Geef me je nummer, ik stuur je een WhatsApp'},
        {hz:'سیگنال نیس، بعداً زنگ می‌زنم',tr:'signal nis, ba\'dan zang mi-zanam',nl:'Geen bereik, ik bel je later'},
      ]
    },

    { id:'internet_social', title:'Internet & Social Media', sub:'Wifi, likes, volgen, uploaden...', icon:'📲', xp:30,
      pronTips:['اینت','آپ'],
      grammar:'"اینترنت" = internet. "لایک" = like. "فالو" = volgen. Jonge Hazara zijn actief op sociale media — veel creators delen hun taal en cultuur online. "وای‌فای پسورد چیه؟" = wat is het wifi-wachtwoord?',
      words:[
        {hz:'اینترنت',tr:'internet',nl:'Internet',tip:'"اینترنت ندارم" = ik heb geen internet'},
        {hz:'وای‌فای',tr:'waay-faay',nl:'Wifi',tip:'"وای‌فای پسورد چیه؟" = wat is het wifi-wachtwoord?'},
        ...
        {hz:'ویدیو',tr:'widio',nl:'Video',tip:'"ویدیو بفرست" = stuur een video'},
      ],
      sentences:[
    ...
    { id:'tech_devices', title:'Apparaten & Computers', sub:'Laptop, lader, batterij...', icon:'💻', xp:30,
      ...
      words:[
        {hz:'کمپیوتر',tr:'kampiyutar',nl:'Computer',tip:'Afghaans woord'},
      ...
      sentences:[
        {hz:'موبایلم شارج نیس، شارجر می‌خوام',tr:'mobayelam shaarj nis, shaarjar mi-khwaam',nl:'Mijn telefoon is niet opgeladen, ik heb een lader nodig'},
        {hz:'لپ‌تاپ کار نمی‌کنه، خراب شده',tr:'lap-taap kaar nami-kona, kharaab shoda',nl:'De laptop werkt niet, hij is kapot'},
        {hz:'حافظه پر اَس، باید چیز پاک کنم',tr:'haafeza por as, baayad chiz paak konam',nl:'De opslag is vol, ik moet iets verwijderen'},
      ]
    },
  ...
  { id:'ch50', label:'☀️ Hoofdstuk 50 · Dagelijkse Routine', color:'#d97706',
    ...
    { id:'morning_routine', title:'Ochtendrutine', sub:'Opstaan, douche, ontbijt...', icon:'🌅', xp:35,
      pronTips:['ب','ص'],
      grammar:'"بیدار شدن" = wakker worden. "صبحانه" = ontbijt. Een Hazara ochtend begint vaak vroeg — gebed, groene thee en naan zijn de basis. "چای صبح" = de heilige ochtendthee.',
      words:[
        ...
        {hz:'آینه',tr:'aaina',nl:'Spiegel',tip:''},
        {hz:'شانه زدن',tr:'shaana zadan',nl:'Haar kammen',tip:''},
        {hz:'عطر',tr:'etar',nl:'Parfum',tip:'"عطر زدن" = parfum opdoen'},
      ],
      sentences:[
        {hz:'صبح بیدار شدم و چای خوردم',tr:'sobh bidaar shodam wa chaay khordam',nl:'Ochtends werd ik wakker en dronk thee'},
        {hz:'دیر می‌شه، زود حاضر شو',tr:'deer mi-sha, zood haazir sho',nl:'We komen te laat, maak je snel klaar'},
        {hz:'صبحانه نخوردم، گرسنه‌ام',tr:'sobhaana nakhordam, gerosnaam',nl:'Ik heb niet ontbeten, ik heb honger'},
      ]
    },
    ...
    { id:'work_school_day', title:'Werkdag & Schooldag', sub:'Werk, lunch, vergadering...', icon:'💼', xp:30,
      ...
      words:[
        ...
        {hz:'همکار',tr:'ham-kaar',nl:'Collega',tip:'Letterlijk: mede-werker'},
      ...
      sentences:[
        {hz:'امروز کار زیاد داشتم، خسته شدم',tr:'emroz kaar ziyaad daashtem, khasta shodam',nl:'Vandaag had ik veel werk, ik ben moe geworden'},
        {hz:'ناهار با همکارانم خوردم',tr:'naahaar baa ham-kaaraanam khordam',nl:'Ik at de lunch met mijn collega\'s'},
        {hz:'جلسه مهم داریم، سر وقت باش',tr:'jalsa-ye mohemm daarem, sar-e waqt baash',nl:'We hebben een belangrijke vergadering, wees op tijd'},
      ]
    },
    ...
    { id:'evening_rest', title:'Avond & Rust', sub:'Avondeten, televisie, slapen...', icon:'🌙', xp:30,
      ...
      words:[
        ...
        {hz:'تلویزیون',tr:'telewiziyon',nl:'Televisie',tip:'"تلویزیون تماشا کردن" = televisie kijken'},
        ...
        {hz:'رویا',tr:'roya',nl:'Droom',tip:'"خواب خوب ببینی" = mooie dromen'},
      ],
      sentences:[
        {hz:'شام خوردیم و تلویزیون دیدیم',tr:'shaam khordem wa telewiziyon dedem',nl:'We aten en keken televisie'},
        {hz:'شب بخیر، خواب خوش',tr:'shab bakheer, khwaab-e khosh',nl:'Goedenacht, slaap lekker'},
        {hz:'فردا زود بیدار شو، کار داریم',tr:'fardaa zood bidaar sho, kaar daarem',nl:'Word morgen vroeg wakker, we hebben werk'},
      ]
    },
  ...
  { id:'ch51', label:'🎊 Hoofdstuk 51 · Feesten & Vieringen', color:'#6d28d9',
    ...
    { id:'nowruz', title:'Norooz (Afghaans Nieuwjaar)', sub:'Lente, bezoeken, cadeautjes...', icon:'🌸', xp:40,
      ...
      words:[
        {hz:'نوروز',tr:'norooz',nl:'Norooz (Afghaans nieuwjaar)',tip:'21 maart — begin van de lente'},
        {hz:'عید مبارک',tr:'eid mobaarak',nl:'Gelukkig Feest!',tip:'Standaard wens bij elk Afghaans feest'},
        {hz:'سال نو',tr:'saal-e nao',nl:'Nieuw jaar',tip:'"سال نو مبارک" = gelukkig nieuwjaar'},
        ...
        {hz:'تعطیل',tr:'ta\'til',nl:'Vrije dag / Vakantie',tip:'"تعطیل هستیم" = we zijn vrij'},
        {hz:'بزم',tr:'bazm',nl:'Feestbijeenkomst',tip:'Muziek, eten, dans — samen'},
      ],
      sentences:[
        {hz:'نوروز مبارک، سال نو خوش',tr:'norooz mobaarak, saal-e nao khosh',nl:'Gelukkig Norooz, een goed nieuwjaar'},
        {hz:'دید و بازدید رفتیم، عیدی گرفتیم',tr:'deed wa baazdeed raftim, eidi gereftem',nl:'We gingen op bezoek en kregen geschenkjes'},
    ...
    { id:'eid_celebration', title:'Eid Viering', sub:'Gebed, familie, Eid-eten...', icon:'🕌', xp:40,
      ...
      sentences:[
        ...
        {hz:'نماز عید خواندیم، بعد دید و بازدید رفتیم',tr:'namaaz-e eid khaandem, ba\'d deed wa baazdeed raftim',nl:'We deden het Eid-gebed, daarna gingen we op bezoek'},
        {hz:'در رمضان روزه گرفتم، سخت بود ولی خوب',tr:'dar ramazaan roza gereftem, sakht bood wali khob',nl:'Ik vastte in de Ramadan, het was zwaar maar goed'},
      ]
    },
    ...
    { id:'birthday_celebrate', title:'Verjaardag & Jubileum', sub:'Taart, kaars, wens, cadeau...', icon:'🎂', xp:30,
      ...
      words:[
        ...
        {hz:'هدیه',tr:'hadiya',nl:'Cadeau',tip:'"هدیه دادن" = een cadeau geven'},
        {hz:'آرزو',tr:'aarazo',nl:'Wens',tip:'"آرزو کو" = doe een wens'},
      ...
      sentences:[
        ...
        {hz:'چه هدیه‌ای بخرم برات؟',tr:'cha hadiyayi bekhorom baraat?',nl:'Wat voor cadeau zal ik voor je kopen?'},
      ]
    },
  ...
  { id:'ch52', label:'📖 Hoofdstuk 52 · Grammatica 6 — Vraagzinnen & Tijdsuitdrukkingen', color:'#065f46',
    ...
    { id:'gram6_questions', title:'Vraagwoorden (verdieping)', sub:'Wie, wat, waar, wanneer, hoe...', icon:'❓', xp:45,
      pronTips:['ک','چ'],
      grammar:'Verdieping van Grammatica 2. Hazaragi zegt "چتور" (chetor) voor "hoe" — NIET het Iraanse "چطور". Vraagwoorden staan vóór of achter de zin, intonatie omhoog. Nieuw hier: samengestelde vraagvormen zoals "از کجا", "با کی", "چه وقت".',
      words:[
        ...
        {hz:'چقدر',tr:'cheqadr',nl:'Hoeveel',tip:'"چقدر اَس؟" = hoeveel kost het?'},
      ...
      sentences:[
        ...
        {hz:'کدام را می‌خوای؟ چقدر می‌دی؟',tr:'kodaam ra mi-khaay? cheqadr mi-di?',nl:'Welke wil je? Hoeveel geef je?'},
      ]
    },

    { id:'gram6_time', title:'Tijdsuitdrukkingen', sub:'Altijd, nooit, soms, al, nog...', icon:'⏰', xp:40,
      pronTips:['ه','گ'],
      grammar:'"هنوز" = nog steeds. "دیگه" = niet meer / al. "همیشه" = altijd. "هیچ‌وقت" = nooit. "گاهی" = soms. Deze tijdswoorden veranderen de betekenis van zinnen volledig — erg belangrijk!',
      words:[
      ...
      sentences:[
        ...
        {hz:'بالاخره فهمیدم، گاهی اشتباه می‌کنم',tr:'baalakhera fahmidam, gaahi eshtbaah mi-konam',nl:'Eindelijk begrijp ik het, soms maak ik fouten'},
      ]
    },

    { id:'gram6_if', title:'Voorwaardelijke Zinnen', sub:'Als...dan, wanneer, tenzij...', icon:'🔀', xp:45,
      pronTips:['ا','ب'],
      grammar:'"اگر" = als (voorwaarde). "وقتی" = wanneer (tijdstip). "مگر" = tenzij. Hazaragi voorwaardelijke zinnen: "اگر X باشه، Y می‌کنم" = als X het geval is, doe ik Y.',
      words:[
      ...
      sentences:[
        ...
        {hz:'با اینکه سخت بود، بالاخره تمام کردم',tr:'baa inke sakht bood, baalakhera tamaam kardam',nl:'Hoewel het moeilijk was, heb ik het uiteindelijk afgemaakt'},
      ]
    },
