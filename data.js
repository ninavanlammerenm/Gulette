...
const CHAPTERS=[
  ...
  { id:'ch0', label:'🆘 Overlevingsgids · Als je vastzit', color:'#F06C78', lessons:[
    ...
    { id:'survival_comm', title:'Ik begrijp het niet!', sub:'Als je vastzit', icon:'🤔', xp:15,
      ...
      words:[
        {hz:'نمی‌فامم',tr:'na-mi-famom',nl:'Ik begrijp het niet',tip:'De meest eerlijke zin als beginner!'},
        {hz:'دوباره بگو',tr:'dobaara bego',nl:'Zeg het nog eens',tip:'"دوباره" = opnieuw'},
        {hz:'خپکی بگو',tr:'khapki bego',nl:'Zeg het langzamer',tip:'Hazaragi: "خپکی" = langzaam/rustig — Iraans zegt "آهسته"'},
        {hz:'چه معنی داره؟',tr:'cha maani daara?',nl:'Wat betekent dit?',tip:'Wijs naar het woord en vraag dit'},
        {hz:'هزارگی نمیدونوم',tr:'hazaaragi na-mi-donom',nl:'Ik ken geen Hazaragi',tip:'Eerlijk en nuttig!'},
      ...
      sentences:[
        {hz:'نمی‌فامم، خپکی بگو',tr:'na-mi-famom, khapki bego',nl:'Ik begrijp het niet, zeg het langzamer'},
    ...
    { id:'survival_agree', title:'Ja, Nee & Misschien', sub:'Meer dan alleen بله en نه', icon:'👍', xp:15,
      ...
      words:[
        ...
        {hz:'نمیدونوم',tr:'na-mi-donom',nl:'Ik weet het niet',tip:'Veelgebruikt — leer dit van buiten!'},
      ...
      sentences:[
        ...
        {hz:'نمیدونوم، شاید',tr:'na-mi-donom, shaayad',nl:'Ik weet het niet, misschien'},
  ...
  { id:'ch4', label:'💬 Hoofdstuk 4 · Conversatie', color:'#3DD6A3', lessons:[
    ...
    { id:'flirt', title:'Romantiek & Gevoelens', sub:'Ik mis je, je bent mooi...', icon:'💌', xp:35,
      ...
      words:[
        ...
        {hz:'نمی‌تانم بی‌تو باشم',tr:'na-mi-taanom bi-tu baasham',nl:'Ik kan niet zonder jou',tip:'Hazaragi: "تانستن"'},
  ...
  { id:'ch5', label:'🌟 Hoofdstuk 5 · Cultuur & Slang', color:'#FFBE3D', lessons:[
    ...
    { id:'slang', title:'Hazara spreektaal', sub:'Echte dagelijkse woorden', icon:'😎', xp:35,
      ...
      sentences:[
        {hz:'والله جان، اصلاً نمیدونوم',tr:'wallah jaan, aslan na-mi-donom',nl:'Echt waar lieverd, ik heb geen idee'},
    ...
    { id:'culture', title:'Cultuur & Tradities', sub:'Gastvrijheid, feesten...', icon:'🎊', xp:35,
      ...
      sentences:[
        ...
        {hz:'مهمان حبیب خداس',tr:'mehman habiib khodaast',nl:'Een gast is de geliefde van God'},
      ]
    },
  ...
  { id:'ch10', label:'👑 Hoofdstuk 10 · Expert Niveau', color:'#A78BFA', lessons:[
    ...
    { id:'fluent_expressions', title:'Spreekwoorden & Wijsheid', sub:'Native-level uitdrukkingen', icon:'💬', xp:65,
      ...
      words:[
        ...
        {hz:'مهمان حبیب خداس',tr:'mehman habiib khodaast',nl:'Een gast is de geliefde van God',tip:''},
  ...
  { id:'ch_gram2', label:'📖 Grammatica 2 · Werkwoorden', color:'#8B6FF0', lessons:[
    ...
    { id:'gram2_negatie', title:'Negatie', sub:'Niet, geen, helemaal niet...', icon:'🚫', xp:25,
      ...
      words:[
        ...
        {hz:'نمیدونوم',tr:'na-mi-donom',nl:'Ik weet het niet',tip:'Veelgebruikte zin — leer dit van buiten!'},
      ...
      sentences:[
        {hz:'نمیدونوم، مشکلی نیس',tr:'na-mi-donom, moshkeli nis',nl:'Ik weet het niet, geen probleem'},
  ...
  { id:'ch_gram3', label:'📖 Grammatica 3 · Gevorderd', color:'#8B6FF0', lessons:[
    ...
    { id:'gram3_postposities', title:'Voorzetsels', sub:'In, van, met, voor...', icon:'🔀', xp:30,
      ...
      sentences:[
        ...
        {hz:'با تو می‌آیم، بدون تو نمی‌رم',tr:'baa tu mi-oom, bedoon tu na-mi-rom',nl:'Ik kom met jou, zonder jou ga ik niet'},
      ]
    },
  ]},
  ...
  { id:'ch22', label:'👗 Hoofdstuk 22 · Kleding & Uiterlijk', color:'#F9C3Cb', lessons:[
    ...
    { id:'clothing_shopping', title:'Kleding kopen', sub:'Maat, passen, betalen...', icon:'🛍️', xp:30,
      ...
      sentences:[
        ...
        {hz:'پرو کنم ببینم چتور اَس',tr:'paro konam bebinam chetor as',nl:'Laat me het passen om te zien hoe het zit'},
  ...
  { id:'ch28', label:'🔄 Hoofdstuk 28 · Tegenstellingen', color:'#F06C78', lessons:[
    ...
    { id:'opp_adj', title:'Tegengestelde bijvoeglijke naamwoorden', sub:'Groot↔Klein, Snel↔Langzaam...', icon:'↔️', xp:25,
      ...
      words:[
        ...
        {hz:'تند ↔ خپکی',tr:'tand ↔ khapki',nl:'Snel ↔ Langzaam',tip:'Hazaragi: "خپکی" = langzaam/rustig'},
  ...
  { id:'ch30', label:'📖 Hoofdstuk 30 · Grammatica 5 — Bijwoorden & Vergelijkingen', color:'#6366f1',
    ...
    { id:'gram5_adverbs', title:'Bijwoorden', sub:'Hoe, wanneer, hoeveel...', icon:'⚡', xp:35,
      ...
      words:[
        ...
        {hz:'خپکی',tr:'khapki',nl:'Langzaam / Rustig',tip:'Hazaragi: "خپکی" — "خپکی بگو" = zeg het langzaam'},
      ...
      sentences:[
        {hz:'تو خیلی تند گپ می‌زنی، خپکی‌تر بگو',tr:'tu khaili tand gap mi-zani, khapki-tar bego',nl:'Jij praat heel snel, spreek wat langzamer'},
    ...
    { id:'gram5_compare', title:'Vergelijkingen', sub:'Groter, beter, het beste...', icon:'📊', xp:40,
      ...
      sentences:[
        ...
        {hz:'تو بهتر اَز دیروز حرف می‌زنی',tr:'tu behtar az diroz harf mi-zani',nl:'Jij praat beter dan gisteren'},
      ]
    },
    ...
    { id:'gram5_conjunctions', title:'Voegwoorden', sub:'Maar, omdat, als, wanneer...', icon:'🔗', xp:35,
      ...
      sentences:[
        {hz:'می‌خوام بیام اما وقت ندارم',tr:'mi-khom biyaam amma waqt nadaaram',nl:'Ik wil komen maar ik heb geen tijd'},
  ...
  { id:'ch36', label:'🏪 Hoofdstuk 36 · Dagelijkse Diensten', color:'#7c3aed',
    ...
    { id:'pharmacy', title:'Apotheek & Medicijnen', sub:'Drogist, recept, pillen...', icon:'💊', xp:35,
      ...
      sentences:[
        {hz:'نسخه داکتر را دارم، دوا می‌خوام',tr:'noskha-ye daaktar ra daaram, dawaa mi-khom',nl:'Ik heb een recept van de dokter, ik wil medicijnen'},
  ...
  { id:'ch37', label:'🧘 Hoofdstuk 37 · Mindset & Motivatie', color:'#7c3aed',
    ...
    { id:'mindset_feelings', title:'Positieve Gevoelens & Kracht', sub:'Blij, sterk, dankbaar...', icon:'🌟', xp:35,
      ...
      sentences:[
        {hz:'خوشحالم که دارم هزارگی یاد می‌گیرم',tr:'khoshaalim ka daaram hazaaragi yaad mi-girom',nl:'Ik ben blij dat ik Hazaragi aan het leren ben'},
  ...
  { id:'ch41', label:'🗣️ Hoofdstuk 41 · Conversatiestrategieën', color:'#1d4ed8',
    ...
    { id:'conv_clarify', title:'Verduidelijken & Herhalen', sub:'Ik begrijp niet, zeg het opnieuw...', icon:'🔄', xp:35,
      pronTips:['خ','ف'],
      grammar:'"دوباره بگو" = zeg het opnieuw. "خپکی بگو" = zeg het langzamer (Hazaragi woord voor آهسته). Dit zijn essentiële zinnen voor iemand die een taal leert — gebruik ze zonder schaamte!',
      words:[
        {hz:'دوباره',tr:'dobaara',nl:'Opnieuw / Nog een keer',tip:'"دوباره بگو" = zeg het opnieuw'},
        {hz:'خپکی',tr:'khapki',nl:'Langzaam',tip:'"خپکی‌تر" = nog langzamer — Hazaragi woord'},
        {hz:'بلند',tr:'boland',nl:'Harder / Luid',tip:'"بلندتر بگو" = spreek harder'},
        {hz:'نفامیدم',tr:'nafamidam',nl:'Ik begreep het niet',tip:'Eerlijk en beleefd zeggen'},
      ...
      sentences:[
        {hz:'دوباره بگو، خپکی‌تر',tr:'dobaara bego, khapki-tar',nl:'Zeg het opnieuw, langzamer'},
        {hz:'نفامیدم، یعنی چی؟',tr:'nafamidam, yani chi?',nl:'Ik begreep het niet, wat betekent dat?'},
    ...
    { id:'conv_agree', title:'Eens of Oneens', sub:'Akkoord, precies, absoluut...', icon:'👍', xp:30,
      ...
      words:[
        ...
        {hz:'نمیدونوم',tr:'na-mi-donom',nl:'Ik weet het niet',tip:'Eerlijk antwoord'},
  ...
  { id:'ch43', label:'🌤️ Hoofdstuk 43 · Weer & Klimaat', color:'#0369a1',
    ...
    { id:'weather_describe', title:'Weer Beschrijven', sub:'IJzig, nat, droog, temperatuur...', icon:'🌡️', xp:30,
      ...
      sentences:[
        ...
        {hz:'جاده یخ زده، خپکی بران',tr:'jaada yakh zada, khapki beraan',nl:'De weg is bevroren, rij langzaam'},
  ...
  { id:'ch47', label:'🚗 Hoofdstuk 47 · Vervoer & Rijden', color:'#1e3a5f',
    ...
    { id:'transport_road', title:'Op de Weg', sub:'Rijden, verkeer, parkeren...', icon:'🛣️', xp:35,
      ...
      sentences:[
        ...
        {hz:'جاده بد اَس، خپکی بران',tr:'jaada bad as, khapki beraan',nl:'De weg is slecht, rij langzaam'},
      ]
    },
  ...
  { id:'ch48', label:'🩺 Hoofdstuk 48 · Bij de Dokter', color:'#0f766e',
    ...
    { id:'doctor_symptoms', title:'Klachten Beschrijven', sub:'Pijn, koorts, duizelig...', icon:'🤒', xp:40,
      pronTips:['د','س'],
      grammar:'"درد" = pijn. "تب" = koorts. "سرماخوردگی" = verkoudheid. In Hazaragi: "خوب نیسم" = ik voel me niet goed. "جای درد کجاست؟" = waar doet het pijn?',
      words:[
        {hz:'درد',tr:'dard',nl:'Pijn',tip:'"درد دارم" = ik heb pijn'},
        {hz:'تب',tr:'tab',nl:'Koorts',tip:'"تب دارم" = ik heb koorts'},
      ...
      sentences:[
        ...
        {hz:'از دیشب تب دارم و سرفه می‌کنم',tr:'az doshab tab daaram wa sorfa mi-konom',nl:'Ik heb al vanaf gisternacht koorts en ik hoest'},
  ...
  { id:'ch49', label:'📱 Hoofdstuk 49 · Telefoon & Technologie', color:'#1d4ed8',
    ...
    { id:'tech_devices', title:'Apparaten & Computers', sub:'Laptop, lader, batterij...', icon:'💻', xp:30,
      ...
      sentences:[
        {hz:'موبایلم شارج نیس، شارجر می‌خوام',tr:'mobayelam shaarj nis, shaarjar mi-khom',nl:'Mijn telefoon is niet opgeladen, ik heb een lader nodig'},
  ...
  { id:'ch52', label:'📖 Hoofdstuk 52 · Grammatica 6 — Vraagzinnen & Tijdsuitdrukkingen', color:'#065f46',
    ...
    { id:'gram6_time', title:'Tijdsuitdrukkingen', sub:'Altijd, nooit, soms, al, nog...', icon:'⏰', xp:40,
      ...
      sentences:[
        ...
        {hz:'بالاخره فامیدم، گاهی اشتباه می‌کنم',tr:'baalakhera fahmidam, gaahi eshtbaah mi-konom',nl:'Eindelijk begrijp ik het, soms maak ik fouten'},
      ]
    },
  ...
  { id:'ch_gram7', label:'📖 Grammatica 7 · Tijden & Ezafe', color:'#8B6FF0', lessons:[
    ...
    { id:'gram7_ke', title:'که-bijzinnen', sub:'Ik weet dat..., de man die...', icon:'🔀', xp:40,
      ...
      words:[
        ...
        {hz:'می‌گویم که',tr:'mi-gom ka',nl:'Ik zeg dat',tip:''},
      ...
      sentences:[
        {hz:'می‌دانم که فردا می‌آیی',tr:'mi-danom ka farda mi-aayi',nl:'Ik weet dat je morgen komt'},
        {hz:'فکر می‌کنم که درست اَس',tr:'fekr mi-konom ka doros as',nl:'Ik denk dat het klopt'},
    ...
    { id:'gram7_maal', title:'مال — Bezit als zelfstandig woord', sub:'Van mij, van jou, het mijne...', icon:'👤', xp:25,
      ...
      sentences:[
        ...
        {hz:'مال ماست، با هم کار می‌کنیم',tr:'maal-e maast, baa ham kaar mi-konim',nl:'Het is van ons, we werken samen'},
      ]
    },
